...
export declare class StreamChat<StreamChatGenerics extends ExtendableGenerics = DefaultGenerics> {
    ...
    */
     ...
     */
    createPoll(poll: PollData, userId?: string): Promise<APIResponse & CreatePollAPIResponse<DefaultGenerics>>;
    /**
     * Retrieves a poll
     ...
     */
    updatePoll(poll: PollData, userId?: string): Promise<APIResponse & UpdatePollAPIResponse<DefaultGenerics>>;
    /**
     ...
     */
    createPollOption(pollId: string, option: PollOptionData, userId?: string): Promise<APIResponse & CreatePollOptionAPIResponse<DefaultGenerics>>;
    /**
     ...
     * @returns {APIResponse & PollOptionResponse} The poll option
     */
    getPollOption(pollId: string, optionId: string, userId?: string): Promise<APIResponse & GetPollOptionAPIResponse<DefaultGenerics>>;
    /**
     ...
     * @returns
     */
    updatePollOption(pollId: string, option: PollOptionData, userId?: string): Promise<APIResponse & UpdatePollOptionAPIResponse<DefaultGenerics>>;
    /**
     ...
     */
    castPollVote(messageId: string, pollId: string, vote: PollVoteData, userId?: string): Promise<APIResponse & CastVoteAPIResponse<DefaultGenerics>>;
    /**
     * Add a poll answer
     * @param messageId string The message id
     * @param pollId string The poll id
     ...
     * @param userId string The user id (only serverside)
     */
    addPollAnswer(messageId: string, pollId: string, answerText: string, userId?: string): Promise<APIResponse & CastVoteAPIResponse<DefaultGenerics>>;
